...
class TensorBoardExporterServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetExperiment = channel.unary_unary(
        '/tensorboard.service.TensorBoardExporterService/GetExperiment',
        request_serializer=tensorboard_dot_uploader_dot_proto_dot_export__service__pb2.GetExperimentRequest.SerializeToString,
        response_deserializer=tensorboard_dot_uploader_dot_proto_dot_experiment__pb2.Experiment.FromString,
        )
...
def add_TensorBoardExporterServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetExperiment': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=tensorboard_dot_uploader_dot_proto_dot_export__service__pb2.GetExperimentRequest.FromString,
          response_serializer=tensorboard_dot_uploader_dot_proto_dot_experiment__pb2.Experiment.SerializeToString,
      ),
