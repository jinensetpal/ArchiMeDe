...
_GETEXPERIMENTREQUEST = _descriptor.Descriptor(
  ...
  full_name='tensorboard.service.GetExperimentRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='experiment_id', full_name='tensorboard.service.GetExperimentRequest.experiment_id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='experiments_mask', full_name='tensorboard.service.GetExperimentRequest.experiments_mask', index=1,
...
_GETEXPERIMENTREQUEST.fields_by_name['experiments_mask'].message_type = tensorboard_dot_uploader_dot_proto_dot_experiment__pb2._EXPERIMENTMASK
...
GetExperimentRequest = _reflection.GeneratedProtocolMessageType('GetExperimentRequest', (_message.Message,), {
  ...
  '__module__' : 'tensorboard.uploader.proto.export_service_pb2'
  # @@protoc_insertion_point(class_scope:tensorboard.service.GetExperimentRequest)
  })
...
_TENSORBOARDEXPORTERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetExperiment',
    full_name='tensorboard.service.TensorBoardExporterService.GetExperiment',
    index=1,
    containing_service=None,
    input_type=_GETEXPERIMENTREQUEST,
    output_type=tensorboard_dot_uploader_dot_proto_dot_experiment__pb2._EXPERIMENT,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
