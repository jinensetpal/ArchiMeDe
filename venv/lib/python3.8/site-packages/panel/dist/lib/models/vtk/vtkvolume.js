...
import { vtkns, data2VTKImageData, hexToRGB, vtkLutToMapper } from "./vtk_utils";
export class VTKVolumePlotView extends AbstractVTKView {
    ...
    _set_slices_visibility(visibility) {
        this._vtk_renwin.getRenderer().getActors().map((actor) => actor.setVisibility(visibility));
    }
}
